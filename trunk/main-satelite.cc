...
//
// ---
// Invoke the itemset SATeLite-based algorithm for all maximal sets.
// ---
...
int main(int argc, char** argv) {
  ...
  if (argc != 2) {
    std::cerr << "ERROR: Usage is: ./ams-satelite <dataset_path>\n";
    return 1;
  }

  {
    ...
    google_extremal_sets::AllMaximalSetsSateLite ap;
